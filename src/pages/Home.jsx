  ...
  return (
    <>
      ...
      <main className="block text-gray-800 bg-marine leading-8">
        <section className="bg-fairy border-none text-slate-50 pt-4 pb-10 px-8">
        ...
        <div className="overflow-hidden w-full h-[54px] rotate-180 border-none">
          <svg className="block w-full h-[56px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M892.25 114.72L0 0 0 120 1200 120 1200 0 892.25 114.72z" className="fill-fairy"></path>
          </svg>
        </div>
          ...
          <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
            ...
            <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {recentPosts.map((recentPost) => {
                ...
                return (
                  <>
                    <Link to={`/post/${urlPathTitle}`} className="max-w-sm mx-auto group rounded-sm bg-pink-200 hover:cursor-pointer shadow-[2px_2px_2px_0px] hover:shadow-[6px_4px_1px_0px] duration-150 hover:no-underline hover:translate-x-[-2px] hover:translate-y-[-1px] focus:no-underline active:shadow-none active:translate-x-[4px] active:translate-y-[3px]">
